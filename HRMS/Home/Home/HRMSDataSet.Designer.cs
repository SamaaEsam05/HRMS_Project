...
namespace Home {
    ...
    public partial class HRMSDataSet : global::System.Data.DataSet {
        ...
        public partial class salaryDataTable : global::System.Data.TypedTableBase<salaryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public salaryRow AddsalaryRow(int ID, double _base, int emp_id) {
...
namespace Home.HRMSDataSetTableAdapters {
    ...
    public partial class salaryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[salary] ([ID], [base], [emp_id]) VALUES (@ID, @base, @emp_id);" +
                "\r\nSELECT ID, base, emp_id FROM salary WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[salary] SET [ID] = @ID, [base] = @base, [emp_id] = @emp_id WHERE ((" +
                "[ID] = @Original_ID) AND ([base] = @Original_base) AND ([emp_id] = @Original_emp" +
                "_id));\r\nSELECT ID, base, emp_id FROM salary WHERE (ID = @ID)";
        ...
        public virtual int Insert(int ID, double _base, int emp_id) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(ID));
            this.Adapter.InsertCommand.Parameters[1].Value = ((double)(_base));
        ...
        public virtual int Update(int ID, double _base, int emp_id, int Original_ID, double Original_base, int Original_emp_id) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(ID));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((double)(_base));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(emp_id));
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_ID));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((double)(Original_base));
        ...
        public virtual int Update(double _base, int emp_id, int Original_ID, double Original_base, int Original_emp_id) {
            return this.Update(Original_ID, _base, emp_id, Original_ID, Original_base, Original_emp_id);
        }
    }
