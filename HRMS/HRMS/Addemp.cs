...
namespace employee_add___manage
{
    ...
    {
        public SqlConnection sqlll = new SqlConnection(ConfigurationManager.ConnectionStrings["HRMScon"].ConnectionString);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(textBox18.Text) && !String.IsNullOrEmpty(textBox4.Text)&&!String.IsNullOrEmpty(textBox20.Text) && !String.IsNullOrEmpty(textBox6.Text) && !String.IsNullOrEmpty(textBox21.Text) && !String.IsNullOrEmpty(textBox22.Text) && !String.IsNullOrEmpty(textBox16.Text) && !String.IsNullOrEmpty(textBox3.Text) && !String.IsNullOrEmpty(textBox4.Text) && !String.IsNullOrEmpty(textBox17.Text) && !String.IsNullOrEmpty(textBox10.Text) && !String.IsNullOrEmpty(textBox12.Text) && !String.IsNullOrEmpty(textBox15.Text) && !String.IsNullOrEmpty(textBox7.Text) && !String.IsNullOrEmpty(textBox8.Text) && !String.IsNullOrEmpty(textBox9.Text) && !String.IsNullOrEmpty(textBox2.Text) && !String.IsNullOrEmpty(textBox1.Text))
            {
                ...
                string query = "INSERT INTO [dbo].[Employee] values(@ID,@manger_id,@department_id,@gender,@Birth_day,@addres,@Email,@degree,@Typee,@Specialization,@Graduation_year,@role_id,@desegnation,@date_of_join,@social_status,@qualification,@phone_num,@id_number,@employees_name,@governrate,@employee_age,@religion)";
        ...
        {
            //emplty all cells
            textBox1.Clear(); textBox2.Clear(); textBox3.Clear(); textBox4.Clear(); textBox4.Clear();
